...
(function(){
  ...
  $('#novo-nome').addEventListener('keyup', e => checkInput(e.currentTarget as HTMLInputElement));
  $('#nova-placa').addEventListener('keyup', e => checkInput(e.currentTarget as HTMLInputElement));
